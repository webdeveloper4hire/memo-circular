...
<form action="add_<?php echo $tb1_colunm1; ?>.php" method="get">
...
<p><label>Type:</label> <input name="tb2_colunm1" type="text" value="<?php echo $tb1_colunm1; ?>" readonly="readonly" /></p>
