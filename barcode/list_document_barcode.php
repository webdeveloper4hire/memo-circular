...
$query_rstable2 = "SELECT * FROM table2 WHERE tb2_colunm1 = 'Document-Action' AND tb2_colunm10 = 'OUT-BARCODED' ORDER BY table2_id DESC";
...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">Document Barcodes<small><?php echo $clientalias ;?> REGION</small> </h3>
</div>
              
    <div class="box-header">
              <a href="search_document.php?tb1_colunm1=<?php echo $_GET['tb1_colunm1'];?>&type=refresh_id&barcoding=yes" class="button" rel="facebox"><button type="submit"  class="btn denr-btn-primary">Add New Document</button></a>
              
              <a href="search_documents.php?tb1_colunm1=Document-Tracking&query=" class="btn denr-btn-primary">Barcoded Existing Documents</a>
             
              <a href="select_barcode_date.php" class="btn denr-btn-primary" rel="facebox">Barcode Report</a>
			...
			<table class="table table-hover">
                ...
                <?php do { ?>
                  <tr>
                    ...
                    <td><a <?php
if ($_SESSION['MM_Username'] == $row_rstable1['tb1_colunm11'] ) { ?>   
href="edit_document.php?table1_id=<?php echo $row_rstable2['tb2_colunm2']; ?>"  <?php } ?> target="_blank">UPDATE</a></td>
